...
const Nav = () => {
  ...
  return (
    <nav>
      <a href='#top' onClick={() => setActiveNav('#top')} className={activNav === '#top' ? 'active' : '/'}><AiOutlineHome /></a>
      ...
      <a href='#portfolio' onClick={() => setActiveNav('#portfolio')} className={activNav === '#portfolio' ? 'active' : ''}><AiOutlineAppstore /></a>
